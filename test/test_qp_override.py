...
class TestQuotePaired(DeferrableViewTestCase):
  def setUp(self):
  ...
  def test_all(self):
    test_set = {
      'b2≠e1' : {
        'txt' :R'''"aa`'___`'⎀'____'aaaa"''',  'qb':"`'", 'qe': "'", 'qp':False,
        False :   " 5 4 3  2 12   34   5 "  ,
        True  :   "3  2    1  1    2    3"  ,  },
      'b1≠e2' : {
        'txt' :R'''"aaa'____'⎀`'___`'aaa"''',  'qb': "'", 'qe':"`'", 'qp':False,
        False :   " 5  43   21 2  3 4  5 "  ,
        True  :   "3   2    1  1    2   3"  ,  },
      'b2≠e2' : {
        'txt' :R'''"aa¦+___¦+⎀+¦___+¦aaa"''',  'qb':"¦+", 'qe':"+¦", 'qp':False,
